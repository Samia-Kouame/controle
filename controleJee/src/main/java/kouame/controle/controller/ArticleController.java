package kouame.controle.controller;
...
import kouame.controle.services.ArticleService;
...
public class ArticleController {
    ...
    public ResponseEntity<Object> findById(@PathVariable Long id) {
        Article entite = service.findById(id);
        if (entite == null) {
    ...
    public List<Article> findProfesseurByCategorie(@RequestBody Categorie categorie) {
